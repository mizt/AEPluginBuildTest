...
cp ../float4x4/PkgInfo ./${PLUGIN}.plugin/Contents/

codesign --force --options runtime --deep --entitlements "../float4x4/entitlements.plist" --sign "Developer ID Application" --timestamp --verbose ${PLUGIN}.plugin
